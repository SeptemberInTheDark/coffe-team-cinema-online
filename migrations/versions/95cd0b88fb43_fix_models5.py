...
Revision ID: 95cd0b88fb43
Revises: 46b52841f2df
Create Date: 2025-01-22 09:31:24.768060
...
revision: str = '95cd0b88fb43'
down_revision: Union[str, None] = '46b52841f2df'
...
def upgrade() -> None:
    ...
    op.alter_column(
        ...
        type_=sa.JSON(),
        postgresql_using="producer::json"  # Явное преобразование данных
    )
    op.alter_column(
        'movie',
        'screenwriter',
        existing_type=sa.String(),
        type_=sa.JSON(),
        postgresql_using="screenwriter::json"  # Явное преобразование данных
    )
    op.alter_column(
        'movie',
        'operator',
        existing_type=sa.String(),
        type_=sa.JSON(),
        postgresql_using="operator::json"  # Явное преобразование данных
    )
    op.alter_column(
        'movie',
        'composer',
        existing_type=sa.String(),
        type_=sa.JSON(),
        postgresql_using="composer::json"  # Явное преобразование данных
    )
    op.alter_column(
        'movie',
        'actors',
        existing_type=sa.String(),
        type_=sa.JSON(),
        postgresql_using="actors::json"  # Явное преобразование данных
    )
    op.alter_column(
        'movie',
        'editor',
        existing_type=sa.String(),
        type_=sa.JSON(),
        postgresql_using="editor::json"  # Явное преобразование данных
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        ...
        type_=sa.String(),
        postgresql_using="editor::text"  # Обратное преобразование
    )
    op.alter_column(
        'movie',
        'actors',
        existing_type=sa.JSON(),
        type_=sa.String(),
        postgresql_using="actors::text"  # Обратное преобразование
    )
    op.alter_column(
        'movie',
        'composer',
        existing_type=sa.JSON(),
        type_=sa.String(),
        postgresql_using="composer::text"  # Обратное преобразование
    )
    op.alter_column(
        'movie',
        'operator',
        existing_type=sa.JSON(),
        type_=sa.String(),
        postgresql_using="operator::text"  # Обратное преобразование
    )
    op.alter_column(
        'movie',
        'screenwriter',
        existing_type=sa.JSON(),
        type_=sa.String(),
        postgresql_using="screenwriter::text"  # Обратное преобразование
    )
    op.alter_column(
        'movie',
        'producer',
        existing_type=sa.JSON(),
        type_=sa.String(),
        postgresql_using="producer::text"  # Обратное преобразование
    )
